...
const PATHS = {
  ...
  rightEye:
    "M 335.0,271.3 C 323.9,274.5 315.6,281.4 311.1,291.0 C 308.9,295.7 308.5,297.9 308.5,306.0 C 308.5,314.3 308.8,316.2 311.3,321.1 C 324.5,348.0 363.1,347.8 375.6,320.8 C 378.2,315.3 378.5,313.4 378.4,305.5 C 378.3,294.5 376.3,289.3 369.0,281.6 C 360.3,272.4 346.1,268.1 335.0,271.3",
  leftPupil:
    "M 161.5,292.0 C 156.2,294.7 153.8,298.3 153.2,304.1 C 152.6,310.1 154.2,314.1 158.6,318.0 C 165.0,323.6 173.7,323.0 180.0,316.5 C 182.9,313.5 183.4,312.2 183.8,307.1 C 184.3,299.8 181.8,295.0 175.9,292.0 C 171.0,289.5 166.5,289.5 161.5,292.0",
  rightPupil:
    "M 335.8,292.0 C 330.1,295.0 327.7,299.9 328.2,307.1 C 328.6,312.2 329.1,313.5 332.0,316.5 C 338.3,323.0 347.0,323.6 353.4,318.0 C 357.8,314.1 359.4,310.1 358.8,304.1 C 358.2,298.2 355.8,294.7 350.4,292.0 C 345.4,289.5 340.6,289.5 335.8,292.0",
  mouth:
    "M 221.8,344.1 C 219.5,345.4 219.6,346.3 222.0,354.4 C 224.6,362.8 232.4,371.6 240.8,375.7 C 245.8,378.1 247.6,378.4 256.0,378.4 C 263.5,378.4 266.5,377.9 270.0,376.3 C 280.5,371.4 287.7,363.1 290.6,352.4 C 293.2,342.5 295.0,343.0 256.1,343.0 C 235.8,343.0 222.8,343.4 221.8,344.1",
};
...
function getCaretClientPos(el: HTMLInputElement | HTMLTextAreaElement) {
  ...
  const textBeforeCaret =
    el instanceof HTMLInputElement && el.type === "password" ? "•".repeat(caretIndex) : el.value.slice(0, caretIndex);
