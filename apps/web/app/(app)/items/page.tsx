...
export default async function ItemsPage({ searchParams }: ItemsPageProps) {
  ...
  const [items, locations, labels] = user
    ? await Promise.all([
        // Always fetch with primary photo path — the client chooses list or grid view.
        itemQueries.searchItemsWithPrimaryPhoto(user.id, { query: q, locationId: filterLocationId, includeArchived }),
  ...
  return (
    ...
    >
      ...
      <ItemViewClient items={items} locationNameById={locationNameById} />
    </CrudShell>
  );
}
